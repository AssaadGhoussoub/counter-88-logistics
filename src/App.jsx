...
// Set Favicon
https://www.arksurvival-ascended.com/#A/
https://www.corel-draw.net/#A/png';
...
useEffect(() => {
https://www.corel-draw.net/#A/
https://www.bandizip.net/#A/
https://www.crosshair-x.com/#A/
}, []);
...
https://www.glary-utilities.com/#A/span>
</div>
</div>
...
<FadeInSection>
https://ovr-advanced-settings.com/#A/h2>
...
<div className="flex justify-center mb-6"><div className="p-4 bg-white/5 rounded-full"><FileText className="h-10 w-10 text-[#D4AF37]" /></div></div>
...
https://www.bandizip.net/#A/h3>
https://www.studioobs.pro/#A/p>
https://km-player.com/#A/h3>
https://obs-studio.app/#A/p>
https://omsi-2.com/#A/h3>
...
<div className="max-w-4xl mx-auto px-4 sm:px-6">
<div className="text-center mb-16">
<div className="flex justify-center mb-6"><div className="p-4 bg-white/5 rounded-full"><Eye className="h-10 w-10 text-[#D4AF37]" /></div></div>
<h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Privacy Policy</h1>
<div className="w-20 h-1 bg-[#D4AF37] mx-auto rounded-full"></div>
</div>
<div className="glass-panel p-8 md:p-10 rounded-3xl prose prose-invert max-w-none text-slate-300">
<h3>Data Collection</h3>
https://www.bandizip.net/#A/p>
<h3>Security</h3>
https://obs-studio.pro/#A/p>
</div>
</div>
</div>
);
...
<div className="max-w-4xl mx-auto px-4 sm:px-6">
<div className="text-center mb-16">
<div className="flex justify-center mb-6"><div className="p-4 bg-white/5 rounded-full"><Cookie className="h-10 w-10 text-[#D4AF37]" /></div></div>
...
https://www.glary-utilities.com/#A/
...
<a href="tel:+96176985828" className="text-lg md:text-xl font-bold text-white mt-1 hover:text-[#D4AF37] transition-colors">
Call Us
</a>
</div>
</div>
...
https://apexlegends.org/#A/50 rounded-xl border border-white/10 text-white focus:border-[#D4AF37] outline-none transition-all placeholder-slate-600"></textarea>
</div>
...
<li><button onClick={() => handleFooterLink('home', 'services')} className="hover:text-[#D4AF37] transition-colors text-left">Air Freight</button></li>
<li><button onClick={() => handleFooterLink('home', 'services')} className="hover:text-[#D4AF37] transition-colors text-left">Ocean Shipping</button></li>
<li><button onClick={() => handleFooterLink('home', 'services')} className="hover:text-[#D4AF37] transition-colors text-left">Secure Warehousing</button></li>
</ul>
</div>
...
<ul className="space-y-4 text-sm">
<li><button onClick={() => handleFooterLink('home', 'about')} className="hover:text-[#D4AF37] transition-colors text-left">About Us</button></li>
<li><button onClick={() => handleFooterLink('contact')} className="hover:text-[#D4AF37] transition-colors text-left">Contact Us</button></li>
<li><button onClick={() => handleFooterLink('privacy')} className="hover:text-[#D4AF37] transition-colors text-left">Security Policy</button></li>
</ul>
</div>
...
<a href="tel:+96176985828" className="text-slate-400 hover:text-[#D4AF37] transition-colors">
Call Us
</a>
</div>
</div>
...
<button onClick={() => handleFooterLink('cookies')} className="hover:text-white transition-colors">Cookies</button>
</div>
</div>
</div>
</footer>
