             ...
             <div className="grid gap-6">
               <div className="glass-panel p-6 rounded-2xl flex items-center group hover:bg-white/5 transition-colors">
                 ...
                 <div className="overflow-hidden">
                   ...
                   <a href="mailto:info@counter-88.com" className="text-lg md:text-xl font-bold text-white mt-1 hover:text-[#D4AF37] transition-colors break-all">
                     Email Us
                   </a>
                 </div>
               </div>
...
const WhatsAppFloat = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:scale-110 transition-transform duration-300 animate-fade-up flex items-center justify-center hover:shadow-[0_0_20px_rgba(37,211,102,0.6)]"
          ...
          <div>
            ...
            <div className="space-y-4 text-sm mb-8">
               <div className="flex items-center">
                 ...
                 <a href="mailto:info@counter-88.com" className="text-slate-400 hover:text-[#D4AF37] transition-colors break-all">
                   Email Us
                 </a>
               </div>
               <div className="flex items-center">
